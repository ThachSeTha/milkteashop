...
<body>
    <div class="user-container">
        ...
        <div class="user-details">
            ...
            <p><i class="fas fa-user"></i><strong>Tên đăng nhập:</strong> {{ $user->name }}</p>
            ...
            <p><i class="fas fa-map-marker-alt"></i><strong>Địa chỉ:</strong> {{ $user->address }}</p>
            <p><i class="fas fa-user-tag"></i><strong>Vai trò:</strong> {{ $user->role->role ?? 'N/A' }}</p>
            <p>
