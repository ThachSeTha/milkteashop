...
<head>
    ...
    <title>Sản phẩm - MilkTeaShop</title>
...
<body>
    <div class="hero-section">
        ...
        <div class="container position-relative text-white">
            ...
            <p>Khám phá bộ sưu tập trà sữa đa dạng với hương vị độc đáo, được làm từ nguyên liệu tươi ngon nhất.</p>
        </div>
    </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <form action="{{ route('donhangs.addToCart') }}" method="POST">
                                                    ...
                                                    <button type="button" class="btn btn-primary add-to-cart" 
                                                        ...
                                                        data-hinh-anh="{{ $sanPham->hinh_anh ?? 'https://via.placeholder.com/300' }}" data-bs-dismiss="modal">Thêm vào giỏ hàng
                                                    </button>
                                                </form>
                                            </div>
                                        </div>
