    ...
    <div class="flex h-screen">
        ...
        <div class="sidebar w-64 text-white">
            ...
            <ul>
                ...
                <li class="mb-3">
                    <a href="{{ route('donhangs.index') }}" class="block">
                        <i class="fas fa-box"></i> Quản lý Đơn Hàng
                    </a>
                </li>
                <li class="mb-3">
                    <a href="{{ route('lienhe') }}" class="block">
                        <i class="fas fa-briefcase"></i> Quản lý Bình luận
                    </a>
                </li>
                <li class="mb-3">
                    <a href="{{ route('gioithieu') }}" class="block">
                        <i class="fas fa-briefcase"></i> Quản lý Khuyến mãi
                    </a>
                </li>
            </ul>
        </div>
